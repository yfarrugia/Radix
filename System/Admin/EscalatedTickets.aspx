<%@ Page Language="VB" MasterPageFile="~/System/Admin/SystemMasterPage.master" AutoEventWireup="false" CodeFile="EscalatedTickets.aspx.vb" Inherits="System_Admin_EscalatedTickets" title="Untitled Page" %>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td>
                        ...
                        AssociatedUpdatePanelID="upNewTickets">
                            <ProgressTemplate>
                ...
                <tr>
                    <td>
                        ...
                        AssociatedUpdatePanelID="upMyTickets">
                            <ProgressTemplate>
                        ...
                        <asp:UpdatePanel ID="upMyTickets" runat="server">
                            <ContentTemplate>
                                <table style="width:100%;">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <asp:GridView ID="gdvMytickets" runat="server" 
                                        CssClass="GridView" 
                                                EmptyDataText="You do currently have any open tickets assigned to you." GridLines="None" 
                                        Width="95%">
                                                <RowStyle CssClass="GridViewRow" />
                                                <Columns>
                                                    <asp:CommandField 
