<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EmployeeRegistration.aspx.vb" Inherits="Anonymous_EmployeeRegistration" title="Employee Registration" EnableEventValidation="false" %>
                                            ...
                                            <table cellpadding="3" style="width:100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" width="150">
                                                        <asp:TextBox ID="txtUsername" runat="server" CssClass="TextBox" Width="150px" 
                                                    ...
                                                    src="../Images/Icons/Warning_Small.png" /></asp:RequiredFieldValidator>
                                                        ...
                                                        <asp:Image ID="imgTick" runat="server" 
                                                    ImageUrl="~/Images/Icons/Tick_Small.png" ToolTip="Username Available" 
                                                    Visible="False" />
                                                ...
                                                <tr>
                                                    ...
                                                    TextMode="Password" Width="150px" MaxLength="20"></asp:TextBox>
                                                    </td>
                                            ...
                                            <asp:View ID="PersonalDetailsView" runat="server">
                                                <table cellpadding="3" style="width:100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" width="150">
                                                            <asp:TextBox ID="txtName" runat="server" CssClass="TextBox" Width="150px" 
                                                    ...
                                                    src="../Images/Icons/Warning_Small.png" /></asp:RequiredFieldValidator>
                                                            ...
                                                            ToolTip="Invalid Name Characters" 
                                                            ValidationExpression="([a-zA-Z\s]{3,30})+" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtSurname" runat="server" CssClass="TextBox" Width="150px" 
                                                            MaxLength="30"></asp:TextBox>
                                                        </td>
                                                        <td align="left">
                                                    ...
                                                    src="../Images/Icons/Warning_Small.png" /></asp:RequiredFieldValidator>
                                                            ...
                                                            ErrorMessage="Invalid E-Mail Format" ForeColor="" 
                                                            ToolTip="Invalid Surname Characters" 
                                                            ValidationExpression="([a-zA-Z\s]{3,30})+" 
                                                            ValidationGroup="3"><img src="../Images/Icons/ErrorCircle_Small.png" /></asp:RegularExpressionValidator>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    ControlExtender="txtDOB_MaskedEditExtender"
                                                    ...
                                                    Width="150px" Height="18px" CssClass="TextBox">
                                                            </asp:DropDownList>
                                                            <br />
                                                        </td>
                                                        <td align="left" valign="middle">
                                                    ...
                                                    <tr>
                                                        <td align="right">
                                                            <asp:Label ID="lblPassportNo" runat="server" CssClass="TextBold" 
                                                            Text="Passport No.:"></asp:Label>
                                                        </td>
                                                        <td align="left" valign="middle">
                                                            <asp:TextBox ID="txtPassportNo" runat="server" CssClass="TextBox" 
                                                            MaxLength="20" Width="150px"></asp:TextBox>
                                                        </td>
                                                        <td align="left" valign="middle">
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" 
                                                            ControlToValidate="txtPassportNo" CssClass="RedText" ErrorMessage="*" 
                                                            ForeColor="" ToolTip="Passport Number is a required field." ValidationGroup="3"><img 
                                                            src="../Images/Icons/Warning_Small.png" /></asp:RequiredFieldValidator>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator12" 
                                                            runat="server" ControlToValidate="txtPassportNo" CssClass="RedText" 
                                                            ErrorMessage="Invalid Passport Number" ForeColor="" ToolTip="Invalid Characters" 
                                                            ValidationExpression="([a-zA-Z0-9]{3,20})+" ValidationGroup="3"><img 
                                                        ...
                                                        <table cellpadding="3" style="width:100%;">
                                                            <tr>
                                                                <td align="center" class="BlueText" colspan="3">
                                                                    ...
                                                                    &nbsp;<asp:LinkButton ID="lblStep2_3" runat="server" CssClass="BlueText">LinkButton</asp:LinkButton>
                                                            ...
                                                            <tr>
                                                                <td align="right" width="40%">
                                                                    <asp:Label ID="lblCountry1" runat="server" CssClass="Text" Text="Center:"></asp:Label>
                                                                </td>
                                                                <td align="left" width="150">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" colspan="2" valign="middle">
                                                                    ...
                                                                    &nbsp;<asp:Button ID="btnContinuetest" runat="server" CssClass="ButtonLightBlue" 
                                                ...
                                                <table style="width:100%;">
                                                    <tr>
                                                        <td align="center" colspan="2" width="40%">
                                                            <asp:LinkButton ID="lblStep1_4" runat="server" CssClass="BlueText">LinkButton</asp:LinkButton>
                                                            &nbsp;<asp:Image ID="Image16" runat="server" ImageUrl="~/Images/NextStep.png" />
                                                            &nbsp;<asp:LinkButton ID="lblStep2_4" runat="server" CssClass="BlueText">LinkButton</asp:LinkButton>
                                                            &nbsp;<asp:Image ID="Image17" runat="server" ImageUrl="~/Images/NextStep.png" />
                                                            <asp:LinkButton ID="lblStep3_4" runat="server" CssClass="BlueText">LinkButton</asp:LinkButton>
                                                            &nbsp;&nbsp;<asp:Image ID="Image18" runat="server" ImageUrl="~/Images/NextStep.png" />
                                                            &nbsp;<asp:Label ID="lblStep4_4" runat="server" CssClass="BlueText" Font-Bold="True" 
                                                            Text="Label"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="justify" class="Text" width="40%" colspan="2">
                                                            Please verify the details you have entered; if all fields are valid please proceed to confirm.</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="right" class="Text" width="40%">
                                                            Center:</td>
                                                        <td align="left" width="60%">
                                                            <asp:Label ID="lblSummaryCenter" runat="server" CssClass="Text" 
                                                            ForeColor="#666666" Text="N/A"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="right" class="Text" width="40%" valign="top">
                                                            Address:</td>
                                                ...
                                                <table style="width:100%;">
                                                    <tr>
                                                        <td class="RedText" align ="center">
                                                            Sorry. An error has occured while trying to register your account.  Please try again.</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            &nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td align="justify" class="Text">
                                                            Should you require any assistance do not hesitate to send us a feedback message and we will get back to you as soon as possible.</td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center">
                                                            &nbsp;</td>
